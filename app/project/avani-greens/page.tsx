      ...
      <section className="project-info-section">
        <div className="container">
          <div className="project-info-card">
            ...
            <div className="top_section_details">
              ...
              <div className="flex-full">
                ...
                <div className="value">
                  <p>B-32 MAHESH NAGAR TONK ROAD JAIPUR Jaipur RJ 302015</p>
                </div>
              </div>
              <div className="flex-full">
                ...
                <div className="value">
                  <p>
                    Avani Greens plots, developed by Real Revolution Buildestate
                    Pvt. Ltd, is a premium residential project strategically
                    located on the Alwar bypass road in Bhiwadi. designed to
                    offer a harmonious balance of modern conveniences and serene
                    landscapes, this project caters to homebuyers looking for a
                    luxurious yet affordable living experience.
                  </p>
                  <p>
                    Spanning across a well-planned area, Avani Greens features
                    300 meticulously designed plots, providing ample space for
                    homeowners to build their dream homes. Whether you are
                    looking for a prime residential plot to construct your ideal
                    house or seeking a high-value investment opportunity, Avani
                    Greens is the perfect choice.
                  </p>
                </div>
              </div>
            ...
            <div className="unit-cost-section">
              <h2 className="unit-cost-title">
                UNIT SIZES & COST (SCHEME PAYMENT PLAN)
              </h2>
              ...
              <div className="important-info-text">
                ...
                <p>
                  POSSESSION CHARGES, MAINTENANCE CHARGES & STAMP DUTY AND
                  REGISTRATION FEES IN RAJASTHAN (AS APPLICABLE)
                </p>
                <p>
                  PAYMENT PLAN IS 10:30:60. FOR DETAILED INFO REFER APPLICATION
                  FORM.
                </p>
              </div>
                  ...
                  <table className="payment-table">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <a
                            href="/downloads/Scheme Site Plan (1).pdf"
                            download
                      ...
                      <tr>
                        ...
                        <td>
                          <a
                            href="/downloads/Scheme-Broucher.pdf"
                            download
                            className="download-link"
                          >
                            DOWNLOAD
                      ...
                      <tr>
                        ...
                        <td>
                          <a
                            href="/downloads/Completion-Certificate-Avani-Greens-A.pdf"
                            download
                            className="download-link"
                          >
                            DOWNLOAD
                      ...
                      <tr>
                        ...
                        <td>
                          <a
                            href="/downloads/Completion-Certificate-Avani-Greens-A (1).pdf"
                            download
                            className="download-link"
                          >
                            DOWNLOAD
                      ...
                      <tr>
                        ...
                        <td>
                          <a
                            href="/downloads/Project-cluster-plan.pdf"
                            download
                            className="download-link"
                          >
                            DOWNLOAD
                      ...
                      <tr>
                        ...
                        <td>
                          <a
                            href="/downloads/90A-Adianth-2.pdf"
                            download
                            className="download-link"
                          >
                            DOWNLOAD
                      ...
                      <tr>
                        ...
                        <td>
                          <a
                            href="/downloads/RERA CERTIFICATE.pdf"
                            download
                            className="download-link"
                          >
                            DOWNLOAD
          ...
          <div className="project-note">
            <p>
              NOTE: REGISTRATION AMOUNT IS FULLY REFUNDABLE TO NON ALLOTTEES
            </p>
          </div>
        </div>
      </section>
